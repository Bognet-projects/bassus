 ...
 */
final class Version20200526191424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8D93D649BAD26311 ON user (tag_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649BAD26311 ON user');
